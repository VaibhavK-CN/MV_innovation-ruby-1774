...
import submitFrom from '@salesforce/apex/LeadController.saveFamilyMemberForLifeInsurance';
import getRelatedFamilyMembers from '@salesforce/apex/LeadController.getRelatedFamilyMembersForLifeInsurance';
//import getFamilyMembers from '@salesforce/apex/LeadController.getFamilyMembers';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { NavigationMixin } from 'lightning/navigation';

export default class ApplicationFamilyMemberForLifeInsurance extends NavigationMixin(LightningElement) {
    @api recordId;
    wiredRecords
    memRecordId
    ...
    handleSave () {
       submitFrom({ recordId: this.recordId, payload: JSON.stringify(this.iterator) })
       .then(result => {
